...
const Navbar = () => {
  ...
  return (
    <div className="flex items-center justify-between py-5 font-medium">
      <Link to="/">
        <img src="/Jeweler.png" className="w-40" alt="Jeweler Logo" />
      </Link>
      ...
      <div className="flex items-center gap-6">
        ...
        <Link to="/cart" className="relative">
          <ShoppingCartIcon className="w-5 cursor-pointer text-gray-700" />
        ...
        >
          <div className="flex flex-col text-gray-700">
            ...
            >
              <ChevronDownIcon className="h-4 rotate-90 text-gray-500" />
              <p>Back</p>
            </div>
            <NavLink
              onClick={() => setVisible(false)}
